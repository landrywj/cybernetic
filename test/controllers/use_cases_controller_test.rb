...
class UseCasesControllerTest < ActionController::TestCase
  ...
  test "should create use_case" do
    assert_difference('UseCase.count') do
      post :create, use_case: { project_id: @use_case.project_id, story: @use_case.story, user: @use_case.user }
    end
  ...
  test "should update use_case" do
    patch :update, id: @use_case, use_case: { project_id: @use_case.project_id, story: @use_case.story, user: @use_case.user }
    assert_redirected_to use_case_path(assigns(:use_case))
  end
